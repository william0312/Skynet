...
#    print(CONTADORES_TRATADA_OUTDOOR[CONTADORES_TRATADA_OUTDOOR['IDENTIFICADOR BENEFICIARIO'] == 22679])
    ...
    DISPOSITIVOS_TRATADA_INDOOR = DISPOSITIVOS_TRATADA[DISPOSITIVOS_TRATADA['TIPO'].isin([
        'indoor',
        'node'])]

    DISPOSITIVOS_TRATADA_OUTDOOR = DISPOSITIVOS_TRATADA[DISPOSITIVOS_TRATADA['TIPO'].isin([
        'outdoor',
        'node'])]
